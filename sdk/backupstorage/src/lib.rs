...
//! offered by AWS Backup Storage. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Backup Storage.
...
/// Configuration for AWS Backup Storage.
pub mod config;
