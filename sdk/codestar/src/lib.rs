...
//! offered by AWS CodeStar. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS CodeStar.
...
/// For example, the [`AssociateTeamMember`](crate::operation::associate_team_member) operation has
/// a [`Client::associate_team_member`], function which returns a builder for that operation.
...
/// Configuration for AWS CodeStar.
pub mod config;
