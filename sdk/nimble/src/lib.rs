...
//! offered by AmazonNimbleStudio. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AmazonNimbleStudio.
...
/// Configuration for AmazonNimbleStudio.
pub mod config;
