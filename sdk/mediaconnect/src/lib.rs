...
/// For example, the [`AddFlowMediaStreams`](crate::operation::add_flow_media_streams) operation has
/// a [`Client::add_flow_media_streams`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `call()` function that returns an async future that
/// returns a result, as illustrated below:
/// 
/// ```rust,ignore
/// let result = client.add_flow_media_streams()
///     .flow_arn("example")
///     .call()
///     .await;
/// ```
