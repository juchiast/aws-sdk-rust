...
//! offered by GameSparks. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`CreateGame`](crate::operation::create_game) operation has
/// a [`Client::create_game`], function which returns a builder for that operation.
