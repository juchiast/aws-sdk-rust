...
impl GetAccessPointPolicyStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetAccessPointPolicyStatus`](crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatusInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatus::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccessPointPolicyStatus {
                type Output = std::result::Result<crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatusOutput, crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatusError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_access_point_policy_status::de_get_access_point_policy_status_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_access_point_policy_status::de_get_access_point_policy_status_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatusError {
...
mod _get_access_point_policy_status_output;
