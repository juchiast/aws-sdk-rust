...
impl PutBucketTaggingInput {
    /// Consumes the builder and constructs an Operation<[`PutBucketTagging`](crate::operation::put_bucket_tagging::PutBucketTagging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bucket_tagging::PutBucketTagging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_tagging::PutBucketTaggingInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_tagging::PutBucketTagging::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutBucketTagging {
                type Output = std::result::Result<crate::operation::put_bucket_tagging::PutBucketTaggingOutput, crate::operation::put_bucket_tagging::PutBucketTaggingError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_bucket_tagging::PutBucketTaggingError {
