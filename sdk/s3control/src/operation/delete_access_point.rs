...
impl DeleteAccessPointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccessPoint`](crate::operation::delete_access_point::DeleteAccessPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_access_point::DeleteAccessPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_access_point::DeleteAccessPointInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_access_point::DeleteAccessPoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAccessPoint {
                type Output = std::result::Result<crate::operation::delete_access_point::DeleteAccessPointOutput, crate::operation::delete_access_point::DeleteAccessPointError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_access_point::de_delete_access_point_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_access_point::de_delete_access_point_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::delete_access_point::DeleteAccessPointError {
