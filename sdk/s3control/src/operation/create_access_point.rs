...
impl CreateAccessPointInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccessPoint`](crate::operation::create_access_point::CreateAccessPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_access_point::CreateAccessPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_access_point::CreateAccessPointInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_access_point::CreateAccessPoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAccessPoint {
                type Output = std::result::Result<crate::operation::create_access_point::CreateAccessPointOutput, crate::operation::create_access_point::CreateAccessPointError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_access_point::de_create_access_point_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_access_point::de_create_access_point_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::create_access_point::CreateAccessPointError {
