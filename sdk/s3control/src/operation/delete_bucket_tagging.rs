...
impl DeleteBucketTaggingInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBucketTagging`](crate::operation::delete_bucket_tagging::DeleteBucketTagging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_bucket_tagging::DeleteBucketTagging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_bucket_tagging::DeleteBucketTaggingInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bucket_tagging::DeleteBucketTagging::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBucketTagging {
                type Output = std::result::Result<crate::operation::delete_bucket_tagging::DeleteBucketTaggingOutput, crate::operation::delete_bucket_tagging::DeleteBucketTaggingError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_bucket_tagging::DeleteBucketTaggingError {
