...
//! offered by AWS IoT RoboRunner. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT RoboRunner.
...
/// For example, the [`CreateWorker`](crate::operation::create_worker) operation has
/// a [`Client::create_worker`], function which returns a builder for that operation.
...
/// Configuration for AWS IoT RoboRunner.
pub mod config;
