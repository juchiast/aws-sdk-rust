...
//! offered by Alexa For Business. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Alexa For Business.
...
/// For example, the [`ApproveSkill`](crate::operation::approve_skill) operation has
/// a [`Client::approve_skill`], function which returns a builder for that operation.
...
/// Configuration for Alexa For Business.
pub mod config;
