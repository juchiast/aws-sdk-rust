...
//! offered by Amazon Honeycode. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Honeycode.
...
/// Configuration for Amazon Honeycode.
pub mod config;
