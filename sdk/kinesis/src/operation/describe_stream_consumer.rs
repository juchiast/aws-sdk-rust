...
impl DescribeStreamConsumerInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStreamConsumer`](crate::operation::describe_stream_consumer::DescribeStreamConsumer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_stream_consumer::DescribeStreamConsumer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_stream_consumer::DescribeStreamConsumerInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_stream_consumer::ser_describe_stream_consumer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_stream_consumer::DescribeStreamConsumer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeStreamConsumer", "kinesis"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeStreamConsumer {
                type Output = std::result::Result<crate::operation::describe_stream_consumer::DescribeStreamConsumerOutput, crate::operation::describe_stream_consumer::DescribeStreamConsumerError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_stream_consumer::de_describe_stream_consumer_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_stream_consumer::de_describe_stream_consumer_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::describe_stream_consumer::DescribeStreamConsumerError {
